...
class SalesViewer(QtWidgets.QWidget):
    ...
    def build_ui(self):
        ...
        self.search_box.setPlaceholderText("بحث برقم الفاتورة / العميل ...")
        ...
        self.table.setHorizontalHeaderLabels(
            ["رقم", "العميل", "الإجمالي", "الخصم", "الصافي", "المستخدم", "التاريخ"]
        )
    ...
    # ============================================================
    def load_data(self):
        self.invoices = self.db.get_sales_invoices()
    ...
    def refresh_table(self, data):
        ...
        for row, inv in enumerate(data):
            ...
            self.table.setItem(row, 1, QtWidgets.QTableWidgetItem(inv["customer"]))
    ...
    def search(self, text):
        ...
        for inv in self.invoices:
            if text in str(inv["id"]) or text in inv["customer"]:
                result.append(inv)
    ...
    def open_invoice_details(self):
        ...
        dlg = InvoiceDetailsDialog(invoice_id, items)
        dlg.exec_()

    # ============================================================
    def export_excel(self):
        Exporter.export_sales_excel(self.invoices)
        QtWidgets.QMessageBox.information(self, "✔", "تم تصدير Excel بنجاح.")

    # ============================================================
    def export_pdf(self):
        Exporter.export_sales_pdf(self.invoices)
