...
class SalesReturnPage(QtWidgets.QWidget):
    ...
    def build_ui(self):
        ...
        title = QtWidgets.QLabel("↩️ مرتجعات المبيعات")
        title.setStyleSheet(
        ...
        self.invoice_id.setPlaceholderText("رقم الفاتورة...")
        ...
        self.table.setHorizontalHeaderLabels(
            ["الصنف", "الكمية الأصلية", "إرجاع", "السعر", "الإجمالي"]
        )
    ...
    def load_invoice(self):
        ...
        items = self.db.get_sales_invoice_items(invoice_id)
    ...
    def save_return(self):
        ...
        return_id = self.db.save_sales_return(invoice_id, items)
    ...
    def print_return(self):
        ...
        filename = f"Sales_Return_{data['return_id']}.pdf"

        printer = ReturnInvoicePrinter()
